    ...
    try:
        ...
        try:            
            ...
            os_profile = OSProfile(
                ...
                admin_username=WINDOWS_IMAGE_USERNAME,
                admin_password=WINDOWS_IMAGE_PASSWORD,
                windows_configuration=WindowsConfiguration(
                    provision_vm_agent=True,
                    enable_automatic_updates=True
                )
            )
            # Use the fresh Windows marketplace image
            # No 'id' needed — just reference the publisher/offer/sku/version
            vm_image_reference = image_reference
            ...
            #os_profile is important, if you use image, this is not need only on fresh Windows
            vm_parameters = VirtualMachine(
                location=location,
                hardware_profile=HardwareProfile(vm_size=vm_size),
                storage_profile=StorageProfile(os_disk=os_disk, image_reference=vm_image_reference),
                network_profile=NetworkProfile(network_interfaces=[NetworkInterfaceReference(id=nic.id)]),
                security_profile=security_profile,
                os_profile=os_profile, #IMPORTANT DIFF BETWEEN FRESH VS VM_IMAGE 
                zones=None
            )
        ...
        try:
            ...
            html_content = html_email.HTMLEmail(
                ...
                image_left_src="",
                image_right_src="",
                logo_src="https://i.postimg.cc/XJCSdSNc/rtxazure.png",
                company_src="https://i.postimg.cc/XJCSdSNc/rtxazure.png",
        ...
        await post_status_update(
            ...
            status_data={
                ...
                "details": {
                    ...
                    "public_ip": public_ip,
                    "url": f"https://cdn.sdappnet.cloud/rtx/rtxvmrun.html?url={public_ip}&vm_name={vm_name}",
                    "timestamp": datetime.utcnow().isoformat()
                }
            }
        )
